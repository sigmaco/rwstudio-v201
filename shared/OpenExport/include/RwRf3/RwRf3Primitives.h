...
public:
    ...
    RwString Write( const RwCommReal& value, bool bin = true );
    RwCommError Read( const RwString& data, RwCommReal& value );
...
public:
    ...
    RwString Write( const RwString& result );
    RwCommError Read( const RwString& buffer, RwString& result );
    RwCommError Create(RwXMLNode* pNode, const RwString& value );
    RwCommError Build(RwXMLNode* pNode, RwString& value );
};
