...
#include "debugostream.h"
   ...
   * \ingroup DebugMacros
   *
   * Pipe output to debug stream - the workspace shows an 'informational' icon.
   *
   */
   ...
   * \ingroup DebugMacros
   *
   * Pipe output to debug stream - the workspace shows a 'warning' icon and the
   * debugger will show the message with 'WARNING - ' prefixed.
   *
   */
   ...
   * \ingroup DebugMacros
   *
   * Pipe output to debug stream - the workspace shows an 'error' icon and the
   * debugger will show the message with 'ERROR - ' prefixed.
   *
   */
