 ...
 /**
   ...
   */
                          ...
                          const char *p_formatstring)
   {
      ...
      {
         RWS_TRACE("(!p_char || strlen(p_char) < 1) return ERROR_NOT_A_VALID_MESSAGE_ID");
   ...
   */
   ...
   void CEventHandler::UnLinkMsg(CEventId &Id)
   {
      ...
      if (Id == ERROR_NOT_A_VALID_MESSAGE_ID)
      {
         RWS_TRACE("(Id == ERROR_NOT_A_VALID_MESSAGE_ID)");
      ...
      {
         RWS_TRACE("CEventId not linked ignoring request to unlink");
      ...
      if (pRMsg->p_msgname != 0)
      {
         ...
         RWS_TRACE("Unable to find link for " << pRMsg->p_msgname);
      }
