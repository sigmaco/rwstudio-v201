...
#ifndef _RWSPLINERESOURCE_H_
#define _RWSPLINERESOURCE_H_
...
namespace RWS
{
   /**
   *
   * \ingroup RwSplineResource
   *
   *  Resource handler for RenderWare Spline file resources.
   *
   */
   class CRwSplineResource: public CResourceHandler
   {
      public:
