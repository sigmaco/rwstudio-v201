/****************************************************************************
*
* File :      CSeqInterpolRwInt8.cpp
*
* Abstract :  Frame by frame sequence controller for RwInt8 data types.
*
*****************************************************************************
*
...
namespace RWS
{
   namespace SEQUENCE
   {
      ...
      //////////////////////////////////////
      //
      // CSeqInterpolLinearRwInt8 functions.
      //
      //

      /**
      *
      * Constructor - sets up attribute packet buffer, with space for data change (RwInt8)
      *               and links to default set/prep/step functions.
      *
      */

      CSeqInterpolLinearRwInt8::CSeqInterpolLinearRwInt8(CSeqItem &rData) :
         CSeqInterpolBase()
      {
         RWS_FUNCTION("RWS::SEQUENCE::CSeqInterpolLinearRwInt8::CSeqInterpolLinearRwInt8");
         RWS_RETURNVOID();
      }
      ...
      */
      ...
      CSeqInterpolLinearRwInt8::~CSeqInterpolLinearRwInt8(void)
      {
         RWS_FUNCTION("RWS::SEQUENCE::CSeqInterpolLinearRwInt8::~CSeqInterpolLinearRwInt8");
      ...
      /**
      *
      * Allocates a new instance of the CSeqInterpolLinearRwInt8 class and returns it via
      * a base class pointer. Asserts if fails to allocated.
      *
      */

      CSeqInterpolBase *CSeqInterpolLinearRwInt8::MakeNew(CSeqItem &rData)
      {
      ...
      */
      ...
      RwUInt32 CSeqInterpolLinearRwInt8::MaxSize(void)
      {
         RWS_FUNCTION("RWS::SEQUENCE::CSeqInterpolLinearRwInt8::MaxSize");
         RWS_RETURN(sizeof(CSeqInterpolLinearRwInt8));
      }
      ...
      */
      ...
      void CSeqInterpolLinearRwInt8::Set(CSeqItem &rData)
      {
         RWS_FUNCTION("RWS::SEQUENCE::CSeqInterpolLinearRwInt8::SetInterpol");
      ...
      */
      ...
      void CSeqInterpolLinearRwInt8::Prep(CSeqItem &rData)
      {
         RWS_FUNCTION("RWS::SEQUENCE::CSeqInterpolLinearRwInt8::Prep");
      ...
      */
      ...
      void CSeqInterpolLinearRwInt8::PrepReuse(CSeqItem &rData)
      {
         RWS_FUNCTION("RWS::SEQUENCE::CSeqInterpolLinearRwInt8::PrepReuse");
      ...
      */
      ...
      /**
      *
      * Calculates the intermediate value for the RwInt8 given the 'now' time and the
      * data held in the CSeqItem passed in. ASSUMES that the 'Prep' has been
      * called before the first call to this function.
      *
      */

      void CSeqInterpolLinearRwInt8::Step(CSeqItem &rData, RwUInt32 nowTime)
      {
         RWS_FUNCTION("RWS::SEQUENCE::CSeqInterpolLinearRwInt8::Step (time)");
         RWS_ASSERT(rData.LastKey()->DataSize(), "Last key's data size invalid.");
         RWS_ASSERT(rData.LastKey()->Data(), "Last key's data pointer invalid.");
         ...
         {
            pCalcVal = reinterpret_cast<RwInt8 *>(rData.BuffSlot()->GetDirectDataSlot());
            ...
            {
               RwInt8 calcVal = CalcValue(pStartVal, m_scaledStep, nowTime, rData.StartTime());
               rData.BuffSlot()->DirectUpdate(&calcVal);
            }
         }
         else
         {
            pCalcVal = reinterpret_cast<RwInt8 *>(rData.BuffSlot()->GetBuffDataSlot(sizeof(RwInt8)));
            *pCalcVal = CalcValue(pStartVal, m_scaledStep, nowTime, rData.StartTime());
         }
      ...
      */
      ...
      /**
      *
      * Calculates the intermediate value for the RwInt8 given a delta value and the
      * data held in the CSeqItem passed in. ASSUMES delta will be in the range of 0.0
      * to 1.0 ONLY.
      *
      */

      void CSeqInterpolLinearRwInt8::Step(CSeqItem &rData, RwReal delta)
      {
         RWS_FUNCTION("RWS::SEQUENCE::CSeqInterpolLinearRwInt8::Step (delta)");
         RWS_ASSERT(rData.LastKey()->DataSize(), "Last key's data size invalid.");
         RWS_ASSERT(rData.LastKey()->Data(), "Last key's data pointer invalid.");
         RWS_ASSERT(rData.EndKey()->DataSize(), "End key's data size invalid.");
         RWS_ASSERT(rData.EndKey()->Data(), "End key's data pointer invalid.");
         ...
         if (rData.BuffSlot()->IsDirectSet())
         {
            ...
            {
               RwInt8 calcVal = CalcValue(pStartVal, pEndVal, delta);
               rData.BuffSlot()->DirectUpdate(&calcVal);
            }
         }
         else
